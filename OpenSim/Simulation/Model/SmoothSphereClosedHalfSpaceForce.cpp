...
#include "SmoothSphereClosedHalfSpaceForce.h"
...
SmoothSphereClosedHalfSpaceForce::SmoothSphereClosedHalfSpaceForce(const std::string& name,
...
void SmoothSphereClosedHalfSpaceForce::extendAddToSystem(
    ...
    auto* mutableThis = const_cast<SmoothSphereClosedHalfSpaceForce*>(this);
    mutableThis->_index = force.getForceIndex();
}

void OpenSim::SmoothSphereClosedHalfSpaceForce::extendRealizeInstance(
...
void SmoothSphereClosedHalfSpaceForce::constructProperties() {
...
SmoothSphereClosedHalfSpaceForce::getRecordLabels() const {
...
OpenSim::Array<double> SmoothSphereClosedHalfSpaceForce::getRecordValues(
        const SimTK::State& state) const {
    ...
    const auto& simtkForce =
            static_cast<const SimTK::SmoothSphereClosedHalfSpaceForce&>(
                    abstractForce);
...
void SmoothSphereClosedHalfSpaceForce::generateDecorations(bool fixed,
