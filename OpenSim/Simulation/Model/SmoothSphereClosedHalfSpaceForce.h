...
@see SimTK::SmoothSphereClosedHalfSpaceForce
...
class OSIMSIMULATION_API SmoothSphereClosedHalfSpaceForce : public Force {
    OpenSim_DECLARE_CONCRETE_OBJECT(SmoothSphereClosedHalfSpaceForce, Force);
...
public:
    ...
    OpenSim_DECLARE_PROPERTY(hunt_crossley_smoothing, double,
            ...
            "default is 50.");
    OpenSim_DECLARE_PROPERTY(fp_tanh_coeff, double,
            "The parameter that determines the steepness of the tanh "
            "function applied to the boundaries of the platform.");
    OpenSim_DECLARE_PROPERTY(fp_center, SimTK::Vec3,
            "The spatial location of the center of the force platform in the "
            "global coordinate system.");
    OpenSim_DECLARE_PROPERTY(fp_x_dim, double,
            "The length of the force platform along the global z-coordinate.");
    OpenSim_DECLARE_PROPERTY(fp_z_dim, double,
            "The length of the force platform along the global "
            "x-coordinate.");
    ...
    // PUBLIC METHODS
    //=========================================================================
    SmoothSphereClosedHalfSpaceForce();

    SmoothSphereClosedHalfSpaceForce(const std::string& name,
...
//=============================================================================
}; // END of class SmoothSphereClosedHalfSpaceForce
//=============================================================================
//=============================================================================

} // namespace OpenSim

#endif // OPENSIM_SMOOTH_SPHERE_CLOSED_HALF_SPACE_FORCE_H_
